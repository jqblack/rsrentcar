...
const listaTipo = [{ label: 'VIP', value: '1' }, { label: 'Normal', value: '2' }]
const listaColor = [{ label: 'Negro', value: '1' }, { label: 'Rojo', value: '2' }, { label: 'Blanco', value: '3' }, { label: 'Azul', value: '4' }, { label: 'Verde', value: '5' }, { label: 'Amarillo', value: '6' }, { label: 'Naranja', value: '7' }, { label: 'Morado', value: '8' }]
const listaMarca = [{ label: 'Toyota', value: '1' }, { label: 'Ford', value: '2' }, { label: 'Honda', value: '3' }, { label: 'Mercedes Benz', value: '4' }, { label: 'KIA', value: '5' }, { label: 'Hyundai', value: '6' }, { label: 'Buggatti', value: '7' }]
const listaCate = [{ label: 'Carro', value: '1' }, { label: 'Jeepeta', value: '2' }, { label: 'Deportivo', value: '3' }, { label: 'Camioneta', value: '4' }]
const listaScore = [{ label: '1', value: '1' }, { label: '2', value: '2' }, { label: '3', value: '3' }, { label: '4', value: '4' }, { label: '5', value: '5' }, { label: '6', value: '6' }, { label: '7', value: '7' }, { label: '8', value: '8' }, { label: '9', value: '9' }, { label: '10', value: '10' }]
